...
public class Console {
   ...
   /**
    * read a word from the console. The word is any set of characters terminated by
    * whitespace
    * 
   ...
   /**
    * read a floating point number from the console. The input is terminated by a
    * newline
    * 
    * @param prompt the prompt string to display
